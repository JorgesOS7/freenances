<template>
  <main class="flex-1 overflow-y-scroll">
    ...
    <section class="container mx-auto px-6 pb-20">
      <div class="mt-5">
        <div class="mb-5 max-w-2xl mx-auto relative top-0 bg-gray-100">
          <input
            type="text"
            class="w-full h-10 rounded-full bg-gray-200 px-10"
          />
          <span class="absolute left-4 top-2.5 text-gray-600">
